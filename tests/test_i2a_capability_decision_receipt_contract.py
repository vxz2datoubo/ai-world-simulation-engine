...
def test_runtime_and_r003_persistence_authority_are_preserved_with_exact_b1_registry_rebind():
    ...
    assert STAGE1_PROVENANCE.task_id == "LW-STAGE1-ORCH-001"
    assert STAGE1_PROVENANCE.snapshot_id == "AWRSE-LW-STAGE1-ORCH-001-SNAPSHOT-001"
    assert STAGE1_PROVENANCE.baseline_sha == "10bfe21fb85dceaf00e784f6e637ae104dac92f6"
